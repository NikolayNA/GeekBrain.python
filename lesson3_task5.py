...
# чисел, то вначале нужно добавить сумму этих чисел к полученной ранее сумме и после
# этого завершить программу.
def my_sum ():
    sum_res = 0
    ex = False
    while ex == False:
        number = input('Введите числа через пробел (или введите X для выхода): ').split()
    ...
    print(f'Вы вышли. Последняя сумма чисел: {sum_res}')
